...
<body>
            ...
            <div style="display: flex; align-items: center; gap: 0.75rem; margin-bottom: 0.5rem;">
                ...
                <div style="flex: 1;">
                    ...
                    <p class="text-xs" style="color: var(--muted);">
                        @if($collocation->users()->where('user_id', Auth::id())->wherePivot('is_owner', true)->exists())
                            Owner
                        @else
                            Membre
                        @endif
    ...
    <main class="main-content">
        <!-- Flash Messages -->
        @if(session('success'))
            <div style="background: rgba(16, 185, 129, 0.1); border: 1px solid var(--accent); color: var(--accent); padding: 1rem; border-radius: 0.5rem; margin-bottom: 1rem;">
                {{ session('success') }}
            </div>
        @endif
        
        @if(session('warning'))
            <div style="background: rgba(245, 158, 11, 0.1); border: 1px solid #f59e0b; color: #f59e0b; padding: 1rem; border-radius: 0.5rem; margin-bottom: 1rem;">
                {{ session('warning') }}
            </div>
        @endif
        ...
        <div class="stat-card" style="margin-bottom: 2rem;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
                <div>
                    ...
                    <p class="text-sm" style="color: var(--muted);">Créée le {{ $collocation->created_at->format('d F Y') }}</p>
                </div>
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1rem;">
            @forelse($collocation->users as $member)
                <div class="glass-card" style="padding: 1rem; display: flex; align-items: center; gap: 1rem;">
                    <div style="width: 48px; height: 48px; border-radius: 50%; background: linear-gradient(to bottom right, 
                    ...
                    <div style="flex: 1;">
                        ...
                        <p class="text-xs" style="color: {{ $member->pivot->is_owner ? '#f59e0b' : 'var(--muted)' }};">
